...
public class StringUtil {
	...
	public static boolean isEmail(String str) {
		...
		String regex2= "[A-Za-z0-9]+@[A-Za-z0-9]+.(com|cn|com.cn|net)";
		return str.matches(regex);
	}
	/**
	 * 判断是否为小写字符串
	 ...
	 * @param args
	 */
	public static String randomChinexeString() {
		String str= null;
		int highPos,lowPos;
		Random random = new Random();
		highPos =(176+Math.abs(random.nextInt(39))); // 区码， OxAO打头，从第16区开始，即OxBO=11*16=176,16~55一级汉字，56~87二级汉字
		random = new Random();
		lowPos = 161+Math.abs(random.nextInt(94)); // 位码， OxAO打头，范围第1~94列
	 ...
	 * @return String 
	 */
	public static String randomChinexeString(int length) {
		String str = "";
		for (int i = 0; i < length; i++) {
			str+=randomChinexeString();
		}
		return str;
	}
	/**
	...
	public static String randomChineseName() {
		String[] username = {"赵", "钱", "孙", "李", "周", "吴", "郑", "王", "冯", "陈", "褚", "卫", "蒋", "沈", "韩", "杨", "朱", "秦",
		...
		// 随机获取姓氏
		String name1 = username[RandomUtil.random(0, username.length-1)];
		//随机获取1-2个中文
		String name2 = randomChinexeString(RandomUtil.random(1, 2));
		return name1+name2;
	
	}
	public static void main(String[] args) {
		//System.out.println(getRandomLetterAndNumberStr(10));
		for (int i = 0; i < 10; i++) {
